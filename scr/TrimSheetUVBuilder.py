...
class TrimSheetBuilderWidget(QWidget):
    def __init__(self):
        ...
        self.setWindowTile("Limb Rigging Tool")
    ...
    def CreateManipulationSection(self):
        ...
        turnBtm.clicked.connect(self.TurnShell)
        sectionLayout.addWidget(turnBtm)

        moveToOriginBtm = QPushButton ("Move To Origin")
        moveToOriginBtm.clicked.connect(self.MoveToOrigin)
        sectionLayout.addWidget(moveToOriginBtm)
    ...
    def GetWindowUniqueid():
        return "e9dd7f78cffbd1cec830828c29fb2c03"
